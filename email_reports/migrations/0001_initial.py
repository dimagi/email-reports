...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('email_reports_reportsubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['email_reports.SchedulableReport'])),
    ...
    def backwards(self, orm):
        # Deleting model 'SchedulableReport'
        db.delete_table('email_reports_schedulablereport')
